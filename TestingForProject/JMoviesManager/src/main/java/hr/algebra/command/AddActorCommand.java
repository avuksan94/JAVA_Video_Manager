...
public class AddActorCommand implements Command {
    ...
    public AddActorCommand(Set<ActorModel> actors, ActorModel actor,MovieModel movie) throws SQLException {
        this.actors = actors;
        this.actor = actor;
        this.movie = movie;
    ...
    public void execute() {
        if (actors.add(actor)) {
            try {
                ...
                Logger.getLogger(AddActorCommand.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
